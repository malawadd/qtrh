...
describe('metadata.ts', () => {
  describe('fetchAccount', () => {
    ...
    it('builds the correct assetConfig history for RAD', async () => {
      ...
      According to mocked ktrhs set events, there should be two active RAD streams.
      */
      ...
      According to mocked ktrhs set events, one of the streams should be paused now.
      */
      ...
      According to mocked ktrhs set events, the previously paused stream should be unpaused.
      */
    ...
    it('builds the correct assetConfig history for DAI', async () => {
      ...
      According to mocked ktrhs set events, there should be one active DAI stream.
      */
