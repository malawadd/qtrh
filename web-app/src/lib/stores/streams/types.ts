/** \<senderUserId\>-\<tokenAddress\>-\<ktrhId\> */
...
export interface KtrhsConfig {
  /** The raw on-chain config value. */
  raw: bigint;
  ktrhId: string;
  /**
   * The amount per second in the smallest possible unit of the respective token, plus
   * extra decimal precision provided by KtrhsHub. To get an amount in the token decimal
...
export interface Stream {
  ...
  archived?: boolean;
  /**
   * If true, the stream was created through the Ktrhs App. If false, it was created
