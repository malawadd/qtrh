...
import type { KtrhsHub, KtrhsHubInterface } from "../KtrhsHub";
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct KtrhsHistory[]",
        name: "ktrhsHistory",
        type: "tuple[]",
      },
    ],
...
export class KtrhsHub__factory {
  static readonly abi = _abi;
  static createInterface(): KtrhsHubInterface {
    return new utils.Interface(_abi) as KtrhsHubInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): KtrhsHub {
    return new Contract(address, _abi, signerOrProvider) as KtrhsHub;
  }
}
