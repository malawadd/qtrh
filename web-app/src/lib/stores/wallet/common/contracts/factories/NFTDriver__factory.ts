...
import type { NFTDriver, NFTDriverInterface } from "../NFTDriver";
...
export class NFTDriver__factory {
  static readonly abi = _abi;
  static createInterface(): NFTDriverInterface {
    return new utils.Interface(_abi) as NFTDriverInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NFTDriver {
    return new Contract(address, _abi, signerOrProvider) as NFTDriver;
  }
}
