  ...
  transact(
    ...
    makeTransactPayload({
      before: async () => {
        ...
        const setKtrhsPopulatedTx = await txFactory.setKtrhs(
          tokenAddress,
          currentReceivers,
          amountToTopUp,
          currentReceivers,
        ...
        delete setKtrhsPopulatedTx.gasLimit;

        const setKtrhsTx = client.setKtrhs(
          tokenAddress,
          currentReceivers,
          currentReceivers,
          address,
      ...
      transactions: ({ setKtrhsTx, setKtrhsPopulatedTx, approvePopulatedTx, needApproval }) =>
        // If the ERC-20 needs approval, we send a batch TX including the approval TX and setKtrhs.
        needApproval
          ? [
              {
              ...
              {
                transaction: setKtrhsPopulatedTx,
                waitingSignatureMessage: {
